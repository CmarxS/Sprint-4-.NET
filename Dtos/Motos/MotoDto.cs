...
namespace MottoMap.DTOs.Motos
{
    ...
    public class CreateMotoDto
    {
        ...
        [MaxLength(50, ErrorMessage = "Marca deve ter no máximo 50 caracteres")]
        ...
        [MaxLength(80, ErrorMessage = "Modelo deve ter no máximo 80 caracteres")]
        ...
        /// </summary>
        [MaxLength(30, ErrorMessage = "Cor deve ter no máximo 30 caracteres")]
    ...
    public class MotoFilterDto
    {
        ...
        /// </summary>
        [Range(0, int.MaxValue, ErrorMessage = "Quilometragem mínima deve ser maior ou igual a zero")]
        public int? QuilometragemMin { get; set; }

        /// <summary>
        /// Filtrar por faixa de quilometragem máxima
        /// </summary>
        [Range(0, int.MaxValue, ErrorMessage = "Quilometragem máxima deve ser maior ou igual a zero")]
